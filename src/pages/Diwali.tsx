...
<div className="absolute inset-0 overflow-hidden">
  ...
  <motion.div
    ...
    className="absolute -left-40 -top-32 w-[650px] h-[650px] rounded-full bg-brand-gold blur-[140px]"
  />
  ...
  <motion.div
    ...
    className="absolute bottom-0 right-0 w-[550px] h-[550px] rounded-full bg-brand-olive blur-[160px]"
  />
...
<div className="w-px h-24 bg-brand-gold/40 mx-auto"/>
...
className="absolute left-32 top-40 text-brand-gold text-5xl"
...
className="absolute right-28 bottom-40 text-brand-gold text-4xl"
...
/>
        ...
        <div className="absolute inset-0 overflow-hidden">
            ...
            <div className="absolute -top-40 -left-40 w-[600px] h-[600px] rounded-full bg-brand-gold/10 blur-[140px]" />

            <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full bg-brand-olive/10 blur-[120px]" />
        ...
        >
            ...
            >
                ...
                <motion.div
                variants={fadeUp}
                className="inline-flex items-center gap-2 rounded-full border border-brand-gold/40 bg-white px-5 py-2 mb-8 shadow-sm"
                >
                ...
                <span className="text-xs tracking-[0.28em] uppercase font-semibold text-brand-olive">
                ...
                <motion.button
                    ...
                    className="group px-8 py-4 rounded-full bg-brand-olive text-white flex items-center gap-3 font-medium shadow-xl"
                ...
                <motion.button
                    ...
                    className="px-8 py-4 rounded-full border border-brand-olive text-brand-olive font-medium backdrop-blur-sm"
            ...
            {/* HERO IMAGE */}
                ...
                initial="hidden"
                animate="show"
                className="relative flex justify-center items-center min-h-[650px]"
                >

                {/* Background Circle */}

                <div className="absolute w-[520px] h-[520px] rounded-full bg-brand-gold/10 blur-3xl" />

                <div className="absolute w-[420px] h-[420px] rounded-full border border-brand-gold/20" />

                <div className="absolute w-[320px] h-[320px] rounded-full border border-brand-olive/10" />
                ...
                >
                    ...
                    <div className="bg-white rounded-[32px] shadow-2xl overflow-hidden p-5 border border-gray-200">

                    <img
                        src="/images/diwali-hamper.png"
                        alt="Luxury Diwali Hamper"
                        className="w-[420px] object-cover rounded-2xl"
                    />
                ...
                >
                    ...
                    <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-xl px-5 py-4 border border-white">
                ...
                {BADGES.map((badge, index) => (
                    ...
                    <div className="bg-white rounded-full shadow-lg px-4 py-2 flex items-center gap-2 border border-gray-100">
                ...
                <motion.div
                    ...
                    className="absolute top-12 left-28 text-brand-gold text-3xl"
                ...
                <motion.div
                    ...
                    className="absolute bottom-10 right-24 text-brand-gold text-2xl"
...
<motion.div
  ...
  className="absolute bottom-10 left-1/2 -translate-x-1/2 lg:left-16 lg:translate-x-0 z-30"
>
  <div className="bg-white/80 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/60 px-8 py-6">
    ...
    <div className="grid grid-cols-3 gap-8">
      ...
      {STATS.map((item) => (
        ...
        >
          ...
          <h3 className="font-serif text-3xl text-brand-olive">

            {item.number}

          </h3>

          <p className="text-xs uppercase tracking-[0.22em] mt-2 text-gray-500">
...
<div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
  ...
  <div className="absolute -left-24 top-24 w-72 h-72 rounded-full bg-brand-gold/5 blur-[120px]" />

  <div className="absolute right-0 bottom-0 w-80 h-80 rounded-full bg-brand-olive/10 blur-[150px]" />
...
<motion.div
  ...
  className="absolute left-16 top-40 text-brand-gold text-5xl"
>
...
<motion.div
  ...
  className="absolute right-20 top-24 text-brand-gold text-3xl"
>
...
<motion.div
  ...
  className="absolute left-1/3 bottom-24 text-brand-gold text-2xl"
>
...
<section className="relative py-32 lg:py-40 overflow-hidden bg-white">
  ...
  <div className="absolute inset-0 pointer-events-none">
    ...
    <div className="absolute -left-32 top-20 w-72 h-72 rounded-full bg-brand-gold/5 blur-[120px]" />

    <div className="absolute right-0 bottom-10 w-96 h-96 rounded-full bg-brand-olive/5 blur-[140px]" />
  ...
  <div className="relative max-w-7xl mx-auto px-6 lg:px-10">
    ...
    <div className="grid lg:grid-cols-2 gap-20 items-center">
      ...
      >
        ...
        <h2 className="font-serif text-brand-charcoal mt-6 leading-tight text-5xl lg:text-6xl">
        ...
        <div className="mt-12 border-l-4 border-brand-gold pl-6">

          <p className="italic font-serif text-2xl text-brand-charcoal leading-relaxed">
      ...
      >
        ...
        <div className="absolute inset-0 bg-brand-beige rounded-[40px] rotate-3" />
    ...
    <div className="grid md:grid-cols-4 gap-8 mt-28">
      ...
      {[
        ...
        >
          ...
          <h2 className="font-serif text-5xl text-brand-olive">

            {item.value}

          </h2>

          <p className="mt-3 uppercase tracking-[0.22em] text-xs text-gray-500">
